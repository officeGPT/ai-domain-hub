...
export default function StableAgentaiPage() {
  return (
    <div className="min-h-screen px-8 py-12 bg-white text-gray-800">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-4">StableAgent.ai</h1>
        ...
        <div className="flex gap-4 mb-8">
          <Link href="https://github.com/yourusername/stableagent" target="_blank">
            <Button variant="outline">View GitHub Repo</Button>
          </Link>
          <Link href="/downloads/stableagent_starter.zip" target="_blank">
